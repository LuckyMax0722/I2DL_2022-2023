...
class ImageFolderDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        data_dict = {}
        image_i = self.load_image_as_numpy(self.images[index]) #load image as numpy array
        if self.transform is None: #check transform is none
            data_dict['image'] = image_i
            data_dict['label'] = self.labels[index] #load label of the image
        else:
            data_dict['image'] = self.transform(image_i) #transform the nparray of image
            data_dict['label'] = self.labels[index] #load label of the image
